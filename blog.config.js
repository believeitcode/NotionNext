...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi， this is BelieveIT welcome to my blog, This site is for me to share my through and knowledge about cybersecurity🎉',
